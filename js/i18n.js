...
const STR = {
  lv: {
    ...
    'stp.back_radar': 'Atpakaļ uz radaru',
    'stp.back_home': 'Atpakaļ uz prognoze.lv',
    'stp.road_station': 'Ceļa meteostacija',
    'stp.lvgmc_station': 'LVĢMC meteostacija',
    'stp.air_temp': 'Gaisa temp.',
    'stp.feels_temp': 'Sajūtu temp.',
    'stp.road_surface_temp': 'Ceļa virsmas temp.',
    'stp.min_24h': 'Min (24h)',
    'stp.max_24h': 'Max (24h)',
    'stp.details': 'Detalizēti rādījumi',
    'stp.wind': 'Vējš',
    'stp.humidity': 'Gaisa mitrums',
    'stp.gust': 'Vēja brāzmas',
    'stp.pressure': 'Atmosfēras spiediens',
    'stp.precip_amount': 'Nokrišņu daudzums',
    'stp.precip_hour': 'Nokrišņi (stundā)',
    'stp.dew': 'Rasas punkts',
    'stp.visibility': 'Redzamība',
    'stp.snow_depth': 'Sniega segas biezums',
    'stp.uv': 'UV indekss',
    'stp.cloud': 'Mākoņainība',
    'stp.lightning': 'Zibens izlādes (stundā)',
    'stp.chart_temp': 'Temperatūra',
    'stp.chart_temp_h': 'Temperatūra ({h}h)',
    'stp.chart_minmax': 'Temperatūra ({h}h) - min/max',
    'stp.chart_wind': 'Vējš ({h}h)',
    'stp.location': 'Atrašanās vieta',
    'stp.station_name': 'Stacijas nosaukums',
    'stp.data_source': 'Datu avots',
    'stp.no_data': 'nav datu',
    'stp.no_data_short': 'Nav datu.',
    'stp.no_station': 'Nav norādīta stacija',
    'stp.missing_id': 'Trūkst ?id= parametra URL.',
    'stp.no_history': 'Vēl nav uzkrātu vēstures datu (dati krājas ik pēc 15 min).',
    'stp.load_failed': 'Neizdevās ielādēt datus.',
    'stp.load_error': 'Kļūda ielādējot datus.',
    'stp.measurements': '{n} mērījumi pēdējās {h}h',
    'stp.no_temp': 'Šai stacijai nav temperatūras datu.',
    'stp.no_wind': 'Šai stacijai nav vēja datu.',
    'stp.no_minmax': 'Šai stacijai nav min/max datu.',
    'stp.no_station_data': 'Šai stacijai nav pieejamu datu.',
    'stp.measurements_hourly': '{n} mērījumi (stundas solī)',
    'stp.oktas': '{n}/9 oktas',
    'stp.ds_air': 'Gaisa temp.',
    'stp.ds_road': 'Ceļa virsmas temp.',
    'stp.ds_feels': 'Sajūtu temp.',
    'stp.ds_min': 'Minimālā T°',
  ...
  en: {
    ...
    'stp.back_radar': 'Back to radar',
    'stp.back_home': 'Back to prognoze.lv',
    'stp.road_station': 'Road weather station',
    'stp.lvgmc_station': 'LVĢMC weather station',
    'stp.air_temp': 'Air temp.',
    'stp.feels_temp': 'Feels-like temp.',
    'stp.road_surface_temp': 'Road surface temp.',
    'stp.min_24h': 'Min (24h)',
    'stp.max_24h': 'Max (24h)',
    'stp.details': 'Detailed readings',
    'stp.wind': 'Wind',
    'stp.humidity': 'Humidity',
    'stp.gust': 'Wind gusts',
    'stp.pressure': 'Atmospheric pressure',
    'stp.precip_amount': 'Precipitation',
    'stp.precip_hour': 'Precipitation (hourly)',
    'stp.dew': 'Dew point',
    'stp.visibility': 'Visibility',
    'stp.snow_depth': 'Snow depth',
    'stp.uv': 'UV index',
    'stp.cloud': 'Cloud cover',
    'stp.lightning': 'Lightning strikes (hourly)',
    'stp.chart_temp': 'Temperature',
    'stp.chart_temp_h': 'Temperature ({h}h)',
    'stp.chart_minmax': 'Temperature ({h}h) - min/max',
    'stp.chart_wind': 'Wind ({h}h)',
    'stp.location': 'Location',
    'stp.station_name': 'Station name',
    'stp.data_source': 'Data source',
    'stp.no_data': 'no data',
    'stp.no_data_short': 'No data.',
    'stp.no_station': 'No station specified',
    'stp.missing_id': 'Missing ?id= URL parameter.',
    'stp.no_history': 'No history accumulated yet (data is collected every 15 min).',
    'stp.load_failed': 'Could not load data.',
    'stp.load_error': 'Error loading data.',
    'stp.measurements': '{n} measurements over the past {h}h',
    'stp.no_temp': 'This station has no temperature data.',
    'stp.no_wind': 'This station has no wind data.',
    'stp.no_minmax': 'This station has no min/max data.',
    'stp.no_station_data': 'No data available for this station.',
    'stp.measurements_hourly': '{n} measurements (hourly)',
    'stp.oktas': '{n}/9 oktas',
    'stp.ds_air': 'Air temp.',
    'stp.ds_road': 'Road surface temp.',
    'stp.ds_feels': 'Feels-like temp.',
    'stp.ds_min': 'Minimum T°',
